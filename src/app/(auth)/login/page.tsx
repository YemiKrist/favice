    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-[#0a1628]">Favice</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link href="/signup" className="text-[#0f2240] font-medium hover:underline">
            Sign up
          </Link>
        </p>
      </div>
